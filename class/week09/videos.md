...
<input type="checkbox" id="week09_video1" class="box"><label>9.1 - Introduction to functions and objects </input></label>

<input type="checkbox" id="week09_video2" class="box"><label>9.2 - Functions basics </input></label>

<input type="checkbox" id="week09_video3" class="box"><label>9.3 - Modularity with functions </input></label>

<input type="checkbox" id="week09_video4" class="box"><label>9.4 - Reusability with functions </input></label>
```
````

## Required Videos

```{dropdown} 9.1 - Introduction to functions and objects
...
```{dropdown} 9.3 - Modularity with functions
    :class-container: sd-shadow-lg
    :color: primary
...
```{dropdown} 9.4 - Reusability with functions
    :class-container: sd-shadow-lg
    :color: primary
