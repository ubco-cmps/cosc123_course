...
```{attention} 
All deadlines in this course (except the Test and Final Exam) have an automatic 48 hour grace period after the due dates listed above.
...
For **only the Labs and Class Activity assignments** this year, here is the flexible grading policy I have instituted:
